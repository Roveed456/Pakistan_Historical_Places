...
class Balochistanpage extends StatefulWidget {
  @override
  _BalochistanpageState createState() => _BalochistanpageState();
}

class _BalochistanpageState extends State<Balochistanpage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.green,
          title: Text('Balochistan Historical places'),
        ),
        body: SafeArea(
